...
#include <nvtx3/nvToolsExt.h>   // For using Nvidia Nsight compute for profiler. 

// nvcc nvtx_matmul.cu -o nvtx_matmul -lnvToolsExt
...
void matrixMul(float* A, float* B, float* C, int N) {
    nvtxRangePush("Matrix Multiplication");   // to separte the tasks
