...
#include <cublas_v2.h>   //for using the cublas 
#include <cuda_fp16.h>    //float point precision 
...
int main() {
    ...
    float C_cpu[M * N], C_cublas_s[M * N]; //single precision
    float C_cublas_h[M * N]; // double precision
