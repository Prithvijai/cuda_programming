...
#include <cublasLt.h>  // for  including the CuBLASLt lib for matrix multiplication
#include <cuda_fp16.h>
#include <iostream>
#include <vector>
#include <iomanip>
...
int main() {
    const int M = 4, K = 4, N = 4;   // CuBLASLt can also take matrics with multiplies of 4. 
    ...
    half *d_A_fp16, *d_B_fp16, *d_C_fp16;   //  the size is reduced half
